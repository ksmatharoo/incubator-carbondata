...
import org.apache.carbondata.processing.newflow.sort.unsafe.holder.UnsafePageHolder;
...
public class UnsafeInMemoryIntermediateDataMerger implements Callable<Void> {
   ...
   */
  public UnsafeInMemoryIntermediateDataMerger(SortParameters mergerParameters,
